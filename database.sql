...
VALUES
  ((SELECT id FROM "user" WHERE "username" = 'tinaj'), 'MN1234', 'Little Explorers Daycare', '123 Oak St', null, 'Minneapolis', 'MN', 55401, '07:30', '17:30', '$40 per day', true, 'Little Explorers Daycare is a nurturing and fun-filled environment where young minds can learn and grow through play and exploration.', 'Hi, I''m Tina, the owner and administrator of Little Explorers Daycare. With a background in early childhood education, I''m committed to providing a safe and stimulating space for children to thrive.', 'This contract outlines the terms and conditions for drop-in daycare services, including hours of operation, rates, and our commitment to your child''s well-being during their time with us.'),
  ((SELECT id FROM "user" WHERE "username" = 'emilya'), 'MN5678', 'ABC Kids Home Daycare', '456 Maple Ave', null, 'St. Paul', 'MN', 55105, '08:00', '18:00', '$35 per day', true, 'At ABC Kids Home Daycare, we foster a creative and supportive environment where children can explore and discover new interests.', 'Hello, I''m Emily, the proud owner and administrator of ABC Kids Home Daycare. With a passion for early childhood development, I''m dedicated to providing enriching experiences for your child.', 'This contract serves as an agreement between us, outlining the terms of our drop-in daycare services, including fees, hours of operation, and our commitment to creating a caring and nurturing space for your child.'),
  ((SELECT id FROM "user" WHERE "username" = 'alejandrap'), 'MN9101', 'Sunshine Daycare Center', '789 Main St', null, 'Richfield', 'MN', 55305, '07:00', '18:30', '$50 per day', true, 'Sunshine Daycare Center provides a warm and inclusive environment where children can explore and develop their natural curiosity.', 'Hi, I''m Alejandra, the director of Sunshine Daycare Center. With a background in early childhood education, I''m dedicated to fostering a love for learning in every child.', 'This contract outlines the terms and conditions for enrollment at Sunshine Daycare Center, including our commitment to providing a safe and nurturing space for your child.'),
  ((SELECT id FROM "user" WHERE "username" = 'johnd'), 'MN2334', 'Tiny Tots Childcare', '101 Elm St', null, 'Minneapolis', 'MN', 55402, '07:00', '17:00', '$45 per day', true, 'Tiny Tots Childcare offers a play-based learning environment where children can thrive and build strong foundations for future success.', 'Hello, I''m John, the owner of Tiny Tots Childcare. As a licensed educator, I''m passionate about creating a supportive space for your child''s growth and development.', 'This contract serves as an agreement between Tiny Tots Childcare and your family, outlining the terms and conditions for our childcare services.'),
  ((SELECT id FROM "user" WHERE "username" = 'safiyaa'), 'MN4345', 'Kiddie Corner Daycare', '222 Pine St', null, 'St. Louis Park', 'MN', 55101, '08:30', '16:30', '$38 per day', true, 'Kiddie Corner Daycare is committed to providing a nurturing and safe environment where children can play, learn, and make new friends.', 'Hi, I''m Safiyaa, the owner of Kiddie Corner Daycare. With years of experience in childcare, I''m dedicated to fostering a love for discovery in every child.', 'This contract outlines the terms and conditions for enrollment at Kiddie Corner Daycare, including our commitment to providing enriching experiences for your child.'),
  ((SELECT id FROM "user" WHERE "username" = 'tomr'), 'MN5612', 'Playful Pals Preschool', '333 Cedar St', null, 'Minnetonka', 'MN', 55345, '08:30', '18:30', '$55 per day', true, 'At Playful Pals Preschool, we believe in fostering creativity and imagination in a structured and engaging environment.', 'Hello, I''m Tom, the director of Playful Pals Preschool. With a background in early childhood development, I''m dedicated to providing a nurturing space for your child''s educational journey.', 'This contract serves as an agreement between Playful Pals Preschool and your family, outlining the terms and conditions for enrollment and the commitment we have to your child''s well-being.'),
  ((SELECT id FROM "user" WHERE "username" = 'alexh'), 'MN1567', 'Nature Explorers Childcare', '444 Oak Ave', null, 'St. Paul', 'MN', 55102, '07:00', '18:00', '$45 per day', true, 'Nature Explorers Childcare provides a unique outdoor learning experience where children can connect with nature and develop a sense of wonder.', 'Hi, I''m Alex, the founder of Nature Explorers Childcare. With a passion for environmental education, I''m committed to nurturing your child''s love for the great outdoors.', 'This contract outlines the terms and conditions for enrollment at Nature Explorers Childcare, including our commitment to providing nature-based learning opportunities for your child.'),
  ((SELECT id FROM "user" WHERE "username" = 'pachouac'), 'MN7878', 'Creative Kids Academy', '555 Birch Rd', null, 'Minneapolis', 'MN', 55403, '08:00', '17:00', '$42 per day', true, 'Creative Kids Academy offers a stimulating and hands-on learning environment where children can explore their creativity.', 'Hello, I''m Pachoua, the director of Creative Kids Academy. With a background in art education, I''m passionate about fostering a love for the arts in young children.', 'This contract serves as an agreement between Creative Kids Academy and your family, outlining the terms and conditions for enrollment and the commitment we have to your child''s artistic growth.'),
  ((SELECT id FROM "user" WHERE "username" = 'davidg'), 'MN2938', 'Little Einsteins Child Development Center', '777 Maple Rd', null, 'St. Paul', 'MN', 55103, '07:30', '17:30', '$48 per day', true, 'Little Einsteins Child Development Center is dedicated to providing a stimulating and intellectually enriching environment for young minds.', 'Hi, I''m David, the owner of Little Einsteins Child Development Center. With a background in early childhood education, I''m committed to inspiring a love for learning in every child.', 'This contract outlines the terms and conditions for enrollment at Little Einsteins Child Development Center, including our commitment to fostering a passion for knowledge and discovery.'),
  ((SELECT id FROM "user" WHERE "username" = 'laurap'), 'MN1122', 'Adventureland Daycare', '888 Pine Ave', null, 'Blaine', 'MN', 55404, '08:00', '18:00', '$37 per day', true, 'Adventureland Daycare offers a play-based learning experience where children can embark on exciting adventures.', 'Hello, I''m Laura, the director of Adventureland Daycare. With a background in child psychology, I''m dedicated to providing a supportive space for your child''s social and emotional development.', 'This contract serves as an agreement between Adventureland Daycare and your family, outlining the terms and conditions for enrollment and the commitment we have to your child''s happiness and growth.');
...
VALUES 
-- Provider 7
(7, 1, 0, 1, 0, '2023-08-05'),
(7, 0, 1, 1, 1, '2023-08-06'),
(7, 1, 1, 0, 1, '2023-08-07'),
...
-- Provider 8
(8, 0, 1, 1, 1, '2023-08-05'),
(8, 1, 0, 1, 0, '2023-08-06'),
(8, 1, 1, 1, 0, '2023-08-07'),
...
-- Provider 9
(9, 1, 0, 0, 1, '2023-08-05'),
(9, 0, 1, 1, 0, '2023-08-06'),
(9, 1, 0, 1, 1, '2023-08-07'),
...
-- Provider 10
(10, 1, 1, 0, 0, '2023-08-05'),
(10, 0, 0, 1, 1, '2023-08-06'),
(10, 1, 1, 1, 1, '2023-08-07'),
...
-- Provider 11
(11, 0, 1, 1, 1, '2023-08-05'),
(11, 1, 0, 1, 0, '2023-08-06'),
(11, 1, 1, 0, 1, '2023-08-07'),
...
-- Provider 12
(12, 1, 1, 0, 0, '2023-08-05'),
(12, 0, 0, 1, 1, '2023-08-06'),
(12, 1, 1, 1, 1, '2023-08-07'),
...
-- Provider 13
(13, 0, 1, 1, 1, '2023-08-05'),
(13, 1, 0, 1, 0, '2023-08-06'),
(13, 1, 1, 0, 1, '2023-08-07'),
...
-- Provider 14
(14, 1, 1, 0, 0, '2023-08-05'),
(14, 0, 0, 1, 1, '2023-08-06'),
(14, 1, 1, 1, 1, '2023-08-07'),
...
-- Provider 15
(15, 0, 1, 1, 1, '2023-08-05'),
(15, 1, 0, 1, 0, '2023-08-06'),
(15, 1, 1, 0, 1, '2023-08-07'),
...
-- Provider 16
(16, 1, 0, 1, 0, '2023-08-05'),
(16, 0, 1, 0, 1, '2023-08-06'),
(16, 1, 1, 1, 1, '2023-08-07'),
